...
public class SettingsFragment extends PreferenceFragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// Configure the library path preference item. Input is a single
		// line of possibly non-English text, which must point to a valid,
		// readable directory.
		EditTextPreference musicFolderPathPref
		...
		musicFolderPathPref
				.setOnPreferenceChangeListener(new MusicFolderChangeListener
						                               ());

	}

	private class MusicFolderChangeListener implements
