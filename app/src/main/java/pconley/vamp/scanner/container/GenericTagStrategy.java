...
public class GenericTagStrategy implements TagStrategy {
	...
	private void buildKeyMap() {
		...
		keys.put(MediaMetadataRetriever.METADATA_KEY_ALBUMARTIST,
		         "albumartist");
