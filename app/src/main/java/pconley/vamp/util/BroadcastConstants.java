...
public final class BroadcastConstants {
	...
	/**
	 * Number of files scanned so far by {@link FileScanVisitor}. If either this
	 * or {@link #EXTRA_TOTAL} is set, then a broadcast with FILTER_SCANNER is
	 * assumed to be an update. Otherwise a broadcast announces the scanner is
	 * finished. {@link #EXTRA_MESSAGE} might be used for information about the
	 * current file.
	 */
	...
	/**
	 * Estimated total number of files and directories to be scanned by {@link
	 * FileScanVisitor}. See {@link #EXTRA_PROGRESS}.
	 */
